...
Bir scheduler, atanmış Node'u olmayan yeni Pod'ları izler. Zamanlayıcı keşfettiği her Pod için o Pod'un üzerinde çalışacağı en iyi Node'u bulmaktan sorumlu olur. Planlayıcı, aşağıda açıklanan programlama prensiplerini dikkate alarak bu yerleştirme kararına ulaşır.
